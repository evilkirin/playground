...
public class GenericTypeParameterExtractor {
    ...
    public static void main(String[] args) {
        System.out.println(findSubClassParameterType(new MyStringSubClass(), MyGenericClass.class, 0));
        MyGenericOuterClass.MyGenericInnerClass instance = new MyStringOuterSubClass().new MyGenericInnerClass();
        System.out.println(findSuperClassParameterType(instance,
                MyGenericOuterClass.MyGenericInnerClass.class, 0));
    }
