...
import interp.antlr.AssemblerV2Lexer;
...
public class Interpreter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        InputStream input;
        if (filename != null)
            input = Interpreter.class.getResourceAsStream(filename);
    ...
    public static boolean load(Interpreter interp, InputStream input) throws Exception {
        boolean hasErrors;
        try {
            AssemblerV2Lexer assemblerV2Lexer = new AssemblerV2Lexer(CharStreams.fromStream(input));
            CommonTokenStream tokens = new CommonTokenStream(assemblerV2Lexer);

            AssemblerV2Parser parser = new AssemblerV2Parser(tokens);
