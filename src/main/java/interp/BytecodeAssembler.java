...
public class BytecodeAssembler extends BaseAssembler {
    ...
    protected void gen(Token instrToken) {
        ...
        int opcode = instructionOpcodeMapping.getOrDefault(instrName, -1);
        if (opcode == -1) {
